...
import com.example.stustay.Ui.Activities.HeartAnimationActivity
import com.example.stustay.Ui.Activities.HomePayActivity
import com.example.stustay.databinding.ActivityHomeBinding

private val YourViewBinding.menuItem4: MenuItem
    get() = menu.findItem(R.id.menu_item4)
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.menu_item4.setOnClickListener {
